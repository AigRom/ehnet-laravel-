...
>
            ...
            <nav class="hidden md:flex items-center gap-1">
                ...
                @auth
                    ...
                    <div class="relative ml-2"
                        ...
                        <div class="flex items-center rounded-xl border border-zinc-200 bg-white shadow-sm overflow-hidden">
                            {{-- Dashboard link --}}
    ...
    <div x-cloak x-show="mobileOpen" x-transition class="md:hidden border-t border-zinc-200/70">
        <div class="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8 space-y-1">
            ...
            @auth
                ...
                <div class="overflow-hidden rounded-xl border border-zinc-200 bg-white">
                    <div class="flex items-center">
                        <a href="{{ route('dashboard') }}"
                           class="flex-1 flex items-center gap-2 px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-100">
                            <x-icons.user-circle class="w-5 h-5" />
                            <span>{{ __('Minu EHNET') }}</span>
                        </a>
