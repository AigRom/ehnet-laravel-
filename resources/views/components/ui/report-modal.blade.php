@props([
    ...
    'description' => __('Vali põhjus, miks soovid sellest kasutajast teada anda. See on praegu ainult disaini prototüüp.'),
    'radioName' => 'report_reason',
])
            ...
            <div class="min-w-0 flex-1">
                ...
                <div class="mt-4 space-y-2">
                    <label class="flex items-center gap-3 rounded-xl border border-zinc-200 px-3 py-2.5 text-sm">
                        <input type="radio" name="{{ $radioName }}" class="h-4 w-4 border-zinc-300 text-green-600 focus:ring-green-500">
