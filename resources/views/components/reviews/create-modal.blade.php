...
<template x-teleport="body">
    <div
        ...
        class="fixed inset-0 z-[9999] flex items-end justify-center bg-zinc-950/60 p-3 sm:items-center sm:p-6"
        role="dialog"
        aria-modal="true"
    ...
    >
        ...
        <div
            ...
            @click.stop
            class="relative z-10 w-full max-w-xl overflow-hidden rounded-[28px] bg-white shadow-2xl"
        >
