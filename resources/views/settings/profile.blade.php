<x-layouts.app.public :title="__('Profiil')">
    @php
        ...
        $secondaryButton = 'inline-flex items-center justify-center gap-2 rounded-2xl border border-emerald-950/10 bg-white px-5 py-3 text-sm font-extrabold text-emerald-950 shadow-sm transition hover:bg-emerald-50 hover:text-emerald-800 hover:shadow-md focus:outline-none focus:ring-4 focus:ring-emerald-900/10';

        $dangerButton = 'inline-flex items-center justify-center gap-2 rounded-2xl border border-red-200 bg-red-50 px-5 py-3 text-sm font-extrabold text-red-700 shadow-sm transition hover:bg-red-100 hover:shadow-md focus:outline-none focus:ring-4 focus:ring-red-200/60';

        $labelClass = 'mb-2 block text-sm font-bold text-emerald-950';

        $inputClass = 'block w-full rounded-2xl border border-emerald-950/10 bg-white px-4 py-3 text-sm font-medium text-emerald-950 placeholder:text-zinc-400 shadow-sm outline-none transition focus:border-emerald-900/30 focus:ring-4 focus:ring-emerald-900/10';

        $inputWithPrefixClass = 'block w-full rounded-2xl border border-emerald-950/10 bg-white py-3 pl-8 pr-4 text-sm font-medium text-emerald-950 placeholder:text-zinc-400 shadow-sm outline-none transition focus:border-emerald-900/30 focus:ring-4 focus:ring-emerald-900/10';
            ...
            >
                ...
                >
                    ...
                    <div class="rounded-[2rem] border border-emerald-950/10 bg-white p-5 shadow-sm sm:p-6">
                        <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex items-center gap-4">
                                <div class="flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-3xl border border-emerald-950/10 bg-stone-100 shadow-sm">
                                    <template x-if="preview">
                                        <img
                                            :src="preview"
                                            alt="{{ __('Uus profiilipilt') }}"
                                    ...
                                    <template x-if="!preview && (removeAvatar || !@js($user->avatar_url))">
                                        <div class="flex h-full w-full items-center justify-center">
                                            <span class="text-lg font-extrabold text-emerald-950">
                                                {{ $user->initials() }}
                                            </span>
                                        </div>
                                    </template>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-sm font-bold text-zinc-500">
                                +
                            </span>
                    ...
                    @if($user->isBusiness())
                        <div class="grid gap-5 sm:grid-cols-2">
                            <div>
                                <label for="contact_first_name" class="{{ $labelClass }}">
                            ...
                            <div>
                                <label for="contact_last_name" class="{{ $labelClass }}">
                            ...
                            <div>
                                <label for="company_name" class="{{ $labelClass }}">
                                    {{ __('Ettevõtte nimi') }}
                                </label>
                            ...
                            <div>
                                <label for="company_reg_no" class="{{ $labelClass }}">
                                    {{ __('Registrikood') }}
                                </label>
